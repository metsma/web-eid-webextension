export default interface Runtime {
   ...
   */
  sendNativeMessage: (application: string, message: object) => Promise<object | void>;
...
export type OnMessageCallback = (message: any, sender: MessageSender) => Promise<any> | void;
